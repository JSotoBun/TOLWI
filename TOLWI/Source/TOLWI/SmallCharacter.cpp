...
void ASmallCharacter::MoveForward(float Value)
{
...
void ASmallCharacter::MoveRight(float Value)
{
	if ((Controller != NULL) && (Value != 0.0f))
	{
...
void ASmallCharacter::TurnAtRate(float Rate)
{
...
void ASmallCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void ASmallCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ASmallCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ASmallCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &ASmallCharacter::TurnAtRate);
